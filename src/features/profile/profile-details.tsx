        ...
        <div>
            ...
            <div className='mt-[5rem] mb-2'>
                <div className='flex items-center gap-4'>
                    ...
                    <Button variant="link" size="icon" className=' cursor-pointer hover:text-blue-700' ><Pencil color='#325ea8' /></Button>
                </div>
                <p className='text-md font-semibold mt-1 ml-2'>Jhon Doe<span className='text-sm text-gray-500'>(@jhon12)</span></p>
            ...
            <div className='border-t-2 mt-5 mb-4'>
                ...
                <div className='mt-4 space-y-2'>
                    <p className='font-semibold'>Name: <span className='text-gray-500'>Jhon Doe</span></p>
                    <p className='font-semibold'>DOB: <span className='text-gray-500'>Jul 7 2002</span></p>
                </div>
            </div>
        </div>
    )
