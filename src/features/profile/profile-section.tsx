        ...
        <div>
            ...
            <div className='mt-[3.5rem]'>
                <div className='flex items-center gap-4'>
                    <Link href="/profile/details/@jhon12" className='text-xl font-medium hover:text-blue-700'>Profile info</Link>
                    <Button variant="link" size="icon" className=' cursor-pointer hover:text-blue-700' onClick={()=>router.push('/profile/edit/@jhon12')}><Pencil color='#325ea8' /></Button>
